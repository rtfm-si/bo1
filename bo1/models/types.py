...
Temperature = Annotated[float, Field(ge=0.0, le=1.0, description="LLM temperature (0-1)")]
"""LLM temperature parameter constrained to 0.0-1.0 range (Anthropic API limit)."""
