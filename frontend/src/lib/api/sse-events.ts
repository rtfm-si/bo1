...
export interface Persona {
	...
	name: string;
	display_name: string;
	archetype: string;         // Expert's role/title (e.g., "Angel Investor")
	domain_expertise: string[];
}

// ============================================================================
// Expert Info (for ExpertPanel component)
// ============================================================================
...
/**
 * Summary generated by AI for compact UI display
 */
export interface ContributionSummary {
	concise: string;          // 1-2 sentence summary (25-40 words)
	looking_for: string;      // What the expert is analyzing (15-25 words)
	value_added: string;      // Unique insight they bring (15-25 words)
	concerns: string[];       // 2-3 specific concerns (10-15 words each)
	questions: string[];      // 1-2 specific questions (10-15 words each)
}
...
export interface ContributionEvent extends SSEEvent {
	...
	data: {
		...
		persona_name: string;
		archetype: string;            // Expert's role/title (e.g., "Angel Investor")
		domain_expertise: string[];   // Expert's areas of expertise
		content: string;              // Full contribution content
		summary: ContributionSummary | null;  // AI-generated structured summary
		round: number;
