...
<div class="bg-neutral-50 dark:bg-neutral-900/50 rounded-lg p-5 border border-neutral-200 dark:border-neutral-700 shadow-sm">
	...
	{#if subProblemGoal}
		<div class="mb-4 p-3 bg-white/60 dark:bg-neutral-800/50 rounded-md border border-info-200 dark:border-info-800">
			<p class="text-xs font-medium text-neutral-700 dark:text-neutral-300">
				<span class="text-neutral-500 dark:text-neutral-400 font-semibold uppercase tracking-wide">Addressing:</span>
	...
	<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
		{#each experts as expert}
			<div class="relative bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 shadow-sm p-3 flex flex-col">
				...
				<div class="text-center mb-2">
					<h4 class="font-semibold text-neutral-900 dark:text-white text-sm truncate">
						{expert.persona.name}
					</h4>
				...
				{#if expert.rationale}
					<div class="flex-1 mt-auto pt-2 border-t border-neutral-100 dark:border-neutral-700">
						<p class="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed line-clamp-3" title={expert.rationale}>
							{expert.rationale}
						</p>
					</div>
				{/if}
