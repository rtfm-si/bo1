...
export { default as PersonaContribution } from './PersonaContribution.svelte';
...
export { default as VotingPhase } from './VotingPhase.svelte';
export { default as PersonaVote } from './PersonaVote.svelte';
