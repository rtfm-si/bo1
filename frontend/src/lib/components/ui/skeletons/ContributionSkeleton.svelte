<script lang="ts">
	/**
	 * ContributionSkeleton - Skeleton loader for expert contribution cards
	 * Matches the ExpertPerspectiveCard layout
	 */
</script>

<div class="bg-white dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-slate-700 animate-pulse">
