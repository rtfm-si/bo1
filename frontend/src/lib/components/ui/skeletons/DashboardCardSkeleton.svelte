<script lang="ts">
	/**
	 * DashboardCardSkeleton - Skeleton loader for dashboard meeting cards
	 * Matches the meeting card layout from dashboard
	 */
</script>

<div class="bg-white dark:bg-neutral-800 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 animate-pulse">
