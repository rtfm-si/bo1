<script lang="ts">
	import { Users, List, TrendingUp, DollarSign, Clock, Activity, BarChart3, History, PieChart, Bell, Tag, MessageSquare, Wrench, Globe, Database, Mail, Zap, ExternalLink, LineChart, Server, FileText, FlaskConical, Image, Search, Shield, AlertTriangle, CreditCard, Lightbulb } from 'lucide-svelte';
...
<div class="min-h-screen bg-neutral-50 dark:bg-neutral-900">
	...
	<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
		...
		<div class="mb-8">
			...
			{/if}
			<!-- Google Search Console (always visible) -->
			<div class="mt-4 flex flex-wrap gap-3">
				<a
					href="https://search.google.com/u/1/search-console?resource_id=sc-domain%3Aboardof.one"
					target="_blank"
					rel="noopener noreferrer"
					class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-neutral-700 dark:text-neutral-300 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 hover:border-error-300 dark:hover:border-error-600 transition-colors"
				>
					<Search class="w-4 h-4 text-error-500" />
					Search Console
					<ExternalLink class="w-3.5 h-3.5 text-neutral-400" />
				</a>
			</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
			...
			>
				<div class="flex items-center gap-4 mb-3">
					<div class="p-3 bg-accent-100 dark:bg-accent-900/30 rounded-lg">
						<FlaskConical class="w-6 h-6 text-accent-600 dark:text-accent-400" />
					</div>
					<div>
						<h3 class="text-lg font-semibold text-neutral-900 dark:text-white">A/B Experiments</h3>
						<p class="text-sm text-neutral-600 dark:text-neutral-400">Track experiment metrics</p>
					</div>
				</div>
				<span class="text-sm text-accent-600 dark:text-accent-400">View experiments →</span>
			</a>
		</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
			...
			>
				<div class="flex items-center gap-4 mb-3">
					<div class="p-3 bg-info-100 dark:bg-info-900/30 rounded-lg">
						<Lightbulb class="w-6 h-6 text-info-600 dark:text-info-400" />
					</div>
					<div>
						<h3 class="text-lg font-semibold text-neutral-900 dark:text-white">Decisions</h3>
						<p class="text-sm text-neutral-600 dark:text-neutral-400">Featured decisions & AI content</p>
					</div>
				</div>
				<span class="text-sm text-info-600 dark:text-info-400">Manage decisions →</span>
			</a>
		</div>
	</main>
</div>
