					...
					<div class="flex items-center justify-between">
						<div class="flex items-center gap-4">
							<div class="w-12 h-12 rounded-lg flex items-center justify-center
								{trafficStats?.status === 'green' ? 'bg-success-100 dark:bg-success-900/30' : ''}
								{trafficStats?.status === 'amber' ? 'bg-warning-100 dark:bg-warning-900/30' : ''}
								{trafficStats?.status === 'red' ? 'bg-error-100 dark:bg-error-900/30' : ''}
						...
						{#if trafficStats}
							<div class="flex items-center gap-2">
								<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
									{trafficStats.status === 'green' ? 'bg-success-100 text-success-800 dark:bg-success-900/30 dark:text-success-400' : ''}
									{trafficStats.status === 'amber' ? 'bg-warning-100 text-warning-800 dark:bg-warning-900/30 dark:text-warning-400' : ''}
									{trafficStats.status === 'red' ? 'bg-error-100 text-error-800 dark:bg-error-900/30 dark:text-error-400' : ''}
								">
						...
						<div class="flex items-center justify-between">
							<div class="flex items-center gap-4">
								<div class="w-12 h-12 rounded-lg flex items-center justify-center
									...
									{service.icon === 'embed' ? 'bg-info-100 dark:bg-info-900/30' : ''}
								">
									{#if service.icon === 'app'}
