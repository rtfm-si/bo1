...
def test_publish_event_basic(publisher, mock_redis):
...
def test_publish_event_json_serialization(publisher, mock_redis):
...
def test_publish_multiple_events(publisher, mock_redis):
...
def test_publish_event_empty_data(publisher, mock_redis):
...
def test_publish_event_complex_data(publisher, mock_redis):
